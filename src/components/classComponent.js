            ...
            <div>
                <Form onSubmit={this.add} ref={this.formData}>
                    <Form.Group controlId="formBasicProductName">
                        <Form.Label>Product Nme:</Form.Label>
                        <Form.Control type="text" placeholder="Enter Product Name" name="product_name" />
                    </Form.Group>

                    <Form.Group controlId="formBasicPrice">
                        <Form.Label>Code:</Form.Label>
                        <Form.Control type="number" placeholder="Enter Code" name="price" />
                    </Form.Group>
                                ...
                                return (
                                    <tr key={index}>
                                        ...
                                        <td>
                                            ...
                                            <Button variant="warning" onClick={event => this.decreQty(event)} value={index}>-</Button>
                                            <Button variant="danger" onClick={event => this.decreQty(event)} value={index}>remove</Button>
